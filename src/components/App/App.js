	...
	render() {
		return (
			<div className="app-container">
				<h1 className="main-heading">TYP-Olympics</h1>
				<h4 className="sub-heading">A playground for <span className="yellow">Faster</span> - <span className="red">Stronger</span> - <span className="green">Higher</span> Developers</h4>
